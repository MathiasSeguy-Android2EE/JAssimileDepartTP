 ...
 * *****************************************************************************************************************</br>
 */
package com.android2ee.formation.jassimile.tp.depart.mmxv.transverse.parser;
...
public class ForcastSaxHandler extends DefaultHandler {
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if (qName.equals(FOR)) {
			...
			currentforecast = new Forecast(text, code, temp);
			...
			text = attributes.getValue(TENDANCE);
			code = attributes.getValue(ICO);
			currentforecast = new Forecast(text, code, templ, temph, dayCount);
			dayCount++;
			forecasts.add(currentforecast);
		}
